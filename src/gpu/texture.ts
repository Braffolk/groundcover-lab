...
function semanticsTag(s: TexelSemantics): string {
  switch (s.kind) {
...
fn mip_texel(base: vec2i, dx: i32, dy: i32) -> vec4f {
 ...
 *
 * This is the house convention, matching `GcMesh.normalAt()` in
 * src/mesh/gcmesh.ts and the ~62 WGSL decoders already in experiments/:
...
// Y-primary, matching GcMesh.normalAt(). Range [0,1] both ways.
