// Offline (in-browser, once) ortho bake of the raw GCMESH1 mesh into one
// atlas tile per view. Used twice:
//   * near pass — one tile per card plane (only that plane's triangle subset
//     is drawn) plus one straight-down top tile.
//   * far  pass — 8 azimuth tiles + 1 top tile of the WHOLE mesh.
// Outputs:
