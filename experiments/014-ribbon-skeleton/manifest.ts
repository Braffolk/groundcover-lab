...
export default defineExperiment({
  ...
  description:
    'Plants distilled into a nested hierarchy of curved ribbons in a 12x360 texture, unrolled as strips in the vertex shader; screen-size LOD morphs each ribbon into its parent, so levels collapse with zero popping.',
  status: 'working',
