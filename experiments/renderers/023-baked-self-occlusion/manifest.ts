...
export default defineExperiment({
  ...
  description:
    'One view-aligned card per plant over a 25-view baked atlas that also stores per-texel surface depth, sky visibility and a bent shading normal. A single depth tap warps the card along the eye ray (parallax inside the silhouette, view-dependent silhouette shape); the baked visibility does the rest — dark interiors, lit tips, sun-direction-dependent self-shadowing, ground contact. A carpet species (Sphagnum) instead draws one ground-parallel tile-sized quad, terrain-conformed per vertex, with the same depth field used as tangent-space parallax relief and only the straight-down view uploaded. 3 taps near, 2 far, no marching, no dither.',
  status: 'working',
